...
sudo apt-get install -y mencoder gettext-base mpich bc openssh-server nfs-common jq libgomp1 build-essential libxml2-dev zlib1g-dev openmpi-bin libopenmpi-dev
